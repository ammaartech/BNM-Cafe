...
export default function TermsAndConditionsPage() {
    ...
    return (
        <div className="min-h-screen bg-background pb-24">
            <div className="sticky top-0 bg-background/90 backdrop-blur-md z-10 px-4 py-4 sm:px-6 shadow-sm border-b">
                <div className="max-w-3xl mx-auto flex items-center justify-between">
                    <Button variant="ghost" size="icon" onClick={() => router.back()} className="rounded-full hover:bg-foreground/5">
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-10">
                <div className="bg-card rounded-2xl p-8 shadow-sm border max-w-none">
                    ...
                    <h2 className="text-2xl font-bold text-foreground mb-4">2. Application Use</h2>
                    <p className="mb-6 text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 mb-6 text-muted-foreground leading-relaxed space-y-2">
                    ...
                    <h2 className="text-2xl font-bold text-foreground mb-4">4. Order Fulfillment and Pickup</h2>
                    <p className="mb-6 text-muted-foreground leading-relaxed">
