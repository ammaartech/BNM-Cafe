# Graph Report - BNM-Cafe  (2026-09-25)

## Corpus Check
- 107 files · ~452,206 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 643 nodes · 1388 edges · 37 communities (31 shown, 6 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 66 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e340fc7`
...
Cohesion: 0.11
Nodes (22): categories, placeholderImages, Station, statusDisplayMap, containerVariants, itemVariants, ProfilePage(), statusMap (+14 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (46): BottomNavBar(), AppLayoutContent(), CartSuccessDialog(), CartPage(), MenuGridProps, CartAction, CartContext, CartContextType (+38 more)
...
Cohesion: 0.10
Nodes (31): AdminLogin(), AdminDashboard(), AdminAnalyticsPage(), MenuGrid(), OrderSidebar(), CashierPageContent(), PENDING_KEY, PendingOrder (+23 more)
...
Cohesion: 0.12
Nodes (21): AdminPage(), fetchAdminOrders(), KOTCard(), safeFormatDistanceToNow(), statusDisplayMap, toOrder(), AlertDialogAction, AlertDialogCancel (+13 more)
...
Cohesion: 0.06
Nodes (34): AdminLayout(), sidebarNavItems, inter, metadata, RootLayoutContent(), Providers(), clearPersistedCache(), config (+26 more)
...
Cohesion: 0.09
Nodes (21): AnalyticsData, RawOrder, MyFeedbackPage(), menuItems, orders, syncOrderStatus(), MENU_KEY, CustomerFeedback (+13 more)
...
Cohesion: 0.06
Nodes (32): AdminLoginPage(), AnalyticsPageContainer(), COLORS, EMPTY_ORDERS, TimeRange, TooltipExplainer(), TrendIndicator(), TrendIndicatorProps (+24 more)
...
## Knowledge Gaps
- **236 isolated node(s):** `PreToolUse`, `allow`, `extends`, `$schema`, `style` (+231 more)
...
- **Why does `useSupabase()` connect `Community 5` to `Community 0`, `Community 1`, `Community 33`, `Community 7`, `Community 51`, `Community 19`, `Community 21`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 1` to `Community 0`, `Community 33`, `Community 4`, `Community 7`, `Community 51`, `Community 19`, `Community 21`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Button` connect `Community 0` to `Community 1`, `Community 33`, `Community 5`, `Community 7`, `Community 51`, `Community 19`, `Community 21`?**
